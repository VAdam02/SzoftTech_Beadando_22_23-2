...
namespace Model.Tiles.Buildings
{
	public class FireDepartmentBuildingTileTest
	{
		...
		{
			Assert.IsTrue(roadGridElement.GetRoadGrid().Workplaces.Contains(fireDepartment));
		}
		...
		public void UnregisterWorkplace_RemovesFireDepartmentFromRoadGrid()
		{
			...
			Assert.IsFalse(roadGridElement.GetRoadGrid().Workplaces.Contains(fireDepartment));
		}
